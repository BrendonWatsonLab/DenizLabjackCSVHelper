...
if ~exist('startDay','var')
    startDay = datetime(2022,05,11,0,00,0);
end
...
if ~exist('BBIds','var')
    ...
    %%A = {'01','02','03','06','07','09','10','15'}
    %%B = {'04','05','08','11','12','13','14','16'}
    %%X = {'06','07','09','11','12','13','15','16'}
    %%Z = {'01','02','03','04','05','08','10','14'}
    %%AX = {'06','07','09','15'}
    %%AZ = {'01','02','03','10'}
    %%BX = {'11','12','13','16'}
    %%BZ = {'04','05','08','14'}
